 ...
 * 老版本，已停止使用
 */
public class ExampleOldVersionActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn1:
                Intent intent = new Intent(ExampleOldVersionActivity.this, ReciteWordActivity.class);
                setResult(1,intent);
                finish();
                break;
            ...
            switch (message.what){
                case 0:
                    ...
                    if(examplelist.size() == 0){
                        ...
                        exampleAdapter = new ExampleAdapter(ExampleOldVersionActivity.this,examplelist,mode,userData.getUsername());
...
//                            .apply(bitmapTransform(new BlurTransformation(25))).into(backdrop);
                    Glide.with(ExampleOldVersionActivity.this).load(captureUtil.getcapture(ExampleOldVersionActivity.this))
                            .apply(bitmapTransform(new BlurTransformation(25))).into(backdrop);
    ...
    private void del_warning(){
        mHandler.obtainMessage(5).sendToTarget();
        SweetAlertDialog del_alert = new SweetAlertDialog(ExampleOldVersionActivity.this,SweetAlertDialog.WARNING_TYPE);
        del_alert.setTitleText("Really?")
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                        ...
                        Toast.makeText(ExampleOldVersionActivity.this,"删除成功",Toast.LENGTH_SHORT).show();
